				...
				<div style={{ marginBottom: 24, border: "2px solid #16a34a", background: "#ecfdf5", padding: 16, borderRadius: 8 }}>
					...
					{!liveError && liveQuote && (
						<div style={{ marginTop: 8 }}>
							<div style={{ fontSize: 14, color: "#000" }}>Symbol: <strong>{liveQuote.symbol}</strong></div>
							<div style={{ fontSize: 32, fontWeight: 700, margin: "4px 0", color: "#000" }}>${Number(liveQuote.price).toFixed(2)}</div>
