...
def get_live_quote(symbol: str):
    """Return latest live quote for a single symbol from websocket cache.
    Response 200: {"symbol":"AAPL","price":182.31,"ts":1697040000000}
    Response 404: {"error":"quote_not_available","symbol":"AAPL"}
    """
